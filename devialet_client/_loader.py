"""Load the bundled Devialet client implementation without importing Home Assistant."""
...
_INTERNAL_NAME = "_devialet_client_internal"
_INTERNAL_ROOT = (
...
def _ensure_internal_package():
    ...
    if spec is None or spec.loader is None:
        raise ImportError("Unable to load bundled Devialet client package")
